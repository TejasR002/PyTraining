...
index()	Searches the string for a specified value and returns the position of where it was found  {print(x.index('s'))}
isalnum()	Returns True if all characters in the string are alphanumeric {print(x.isalnum())}
