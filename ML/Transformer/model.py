...
class DecoderBlock(nn.Module):
    ...
    def __init__(self,self_attention_block:MultiHeadAttentionBlock,cross_attention_block:MultiHeadAttentionBlock,feed_forward_block:FeedForwardBlock,dropout : float)-> None:
        ...
        self.feed_forward_block = feed_forward_block
        self.residual_connection = nn.ModuleList([ResidualConeection(dropout) for _ in range(3)])
...
class Transformer(nn.Module):
    ...
    def __init__(self, encoder:Encoder,decoder:Decoder,src_embed:InputEmeddings,tgt_embed:InputEmeddings,src_pos:PositionalEncoding,tgt_pos:PositionalEncoding,projection_layer:ProjectionLayer)->None:
        super().__init__()
...
def build_transformer(src_vocab_size:int,tgt_vocab_size : int,src_seq_len:int,tgt_seq_len:int,d_model:int = 512,N:int = 5,h:int = 8, dropout : float = 0.1,d_ff:int = 2048)->Transformer:
    ...
    src_embed = InputEmeddings(d_model,src_vocab_size)
    tgt_embed = InputEmeddings(d_model,tgt_vocab_size)
